...
about 35 seconds instead of leaving one message and hanging up. `build_hardened_task` now appends a fourth fixed block,
...
below): it tells the agent to give a clear, brief recap of what was
